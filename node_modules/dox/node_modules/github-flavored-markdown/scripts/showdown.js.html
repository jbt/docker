...
<head>
  ...
  <script>
    var relativeDir = '../../../../../', thisFile = 'node_modules/dox/node_modules/github-flavored-markdown/scripts/showdown.js';
  </script>
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h2">
        <a href="#jj-the-line-above-breaks-this-">jj the line above breaks this:</a>
      </div>
    </div>
  </div>
...
<p>showdown.js -- A javascript port of Markdown.</p>
...
<div class="highlight"><pre><code>        <span class="n">A</span> <span class="n">A</span> <span class="n">L</span>
        <span class="n">T</span> <span class="n">C</span> <span class="n">A</span>
        <span class="n">T</span> <span class="n">K</span> <span class="n">B</span>
</code></pre></div>
...
<p>Wherever possible, Showdown is a straight, line-by-line port
...
<p>Showdown namespace</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre><span class="kd">var</span> <span class="nx">Showdown</span> <span class="o">=</span> <span class="p">{};</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>isaacs: export the Showdown object</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre><span class="k">if</span> <span class="p">(</span><span class="k">typeof</span> <span class="nx">exports</span> <span class="o">===</span> <span class="s2">&quot;object&quot;</span><span class="p">)</span> <span class="p">{</span>
...
<p>isaacs: expose top-level parse() method, like other to-html parsers.</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">Showdown</span><span class="p">.</span><span class="nx">parse</span> <span class="o">=</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">md</span><span class="p">,</span> <span class="nx">gh</span><span class="p">)</span> <span class="p">{</span>
...
<p>isaacs: Declare "GitHub" object in here, since Node modules
execute in a closure or separate context, rather than right
in the global scope.  If in the browser, this does nothing.</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre><span class="kd">var</span> <span class="nx">GitHub</span><span class="p">;</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
exposed is makeHtml().</p>
        ...
        <td class="code highlight"><div class="highlight"><pre><span class="nx">Showdown</span><span class="p">.</span><span class="nx">converter</span> <span class="o">=</span> <span class="kd">function</span><span class="p">()</span> <span class="p">{</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>Global hashes, used by various utility routines</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre><span class="kd">var</span> <span class="nx">g_urls</span><span class="p">;</span>
...
<p>Used to track when we're inside an ordered or unordered list
(see _ProcessListItems() for details):</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre><span class="kd">var</span> <span class="nx">g_list_level</span> <span class="o">=</span> <span class="mi">0</span><span class="p">;</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>isaacs - Allow passing in the GitHub object as an argument.</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre><span class="k">this</span><span class="p">.</span><span class="nx">makeHtml</span> <span class="o">=</span> <span class="kd">function</span><span class="p">(</span><span class="nx">text</span><span class="p">,</span> <span class="nx">gh</span><span class="p">)</span> <span class="p">{</span>
...
<p>Main function. The order in which other subs are called here is
...
<p>Clear the global hashes. If we don't clear these, you get conflicts
from other articles when generating a page which contains more than
one article (e.g. an index page that shows the N most recent
articles):</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">g_urls</span> <span class="o">=</span> <span class="k">new</span> <span class="nb">Array</span><span class="p">();</span>
...
<p>attacklab: Replace ~ with ~T
This lets us use tilde as an escape char to avoid md5 hashes
The choice of character is arbitray; anything that isn't
magic in Markdown will work.</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/~/g</span><span class="p">,</span><span class="s2">&quot;~T&quot;</span><span class="p">);</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>attacklab: Replace $ with ~D
RegExp interprets $ as a special character
when it's in a replacement string</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/\$/g</span><span class="p">,</span><span class="s2">&quot;~D&quot;</span><span class="p">);</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>Standardize line endings</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/\r\n/g</span><span class="p">,</span><span class="s2">&quot;\n&quot;</span><span class="p">);</span> <span class="c1">// DOS to Unix</span>
...
<p>Make sure text begins and ends with a couple of newlines:</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="s2">&quot;\n\n&quot;</span> <span class="o">+</span> <span class="nx">text</span> <span class="o">+</span> <span class="s2">&quot;\n\n&quot;</span><span class="p">;</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>Convert all tabs to spaces.</p>
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">_Detab</span><span class="p">(</span><span class="nx">text</span><span class="p">);</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>Strip any lines consisting only of spaces and tabs.
This makes subsequent regexen easier to write, because we can
match consecutive blank lines with /\n+/ instead of something
contorted like /[ \t]*\n+/ .</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/^[ \t]+$/mg</span><span class="p">,</span><span class="s2">&quot;&quot;</span><span class="p">);</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>Turn block-level HTML blocks into hash entries</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">_HashHTMLBlocks</span><span class="p">(</span><span class="nx">text</span><span class="p">);</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>Strip link definitions, store in hashes.</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">_StripLinkDefinitions</span><span class="p">(</span><span class="nx">text</span><span class="p">);</span>
...
<p>attacklab: Restore dollar signs</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/~D/g</span><span class="p">,</span><span class="s2">&quot;$$&quot;</span><span class="p">);</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>attacklab: Restore tildes</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/~T/g</span><span class="p">,</span><span class="s2">&quot;~&quot;</span><span class="p">);</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p><em>* GFM *</em>  Auto-link URLs and emails</p>
        </td>
...
<p><em>* GFM *</em> Auto-link sha1 if GitHub.nameWithOwner is defined</p>
        </td>
...
<p><em>* GFM *</em> Auto-link user@sha1 if GitHub.nameWithOwner is defined</p>
        </td>
...
<p><em>* GFM *</em> Auto-link user/repo@sha1</p>
        </td>
...
<p><em>* GFM *</em> Auto-link #issue if GitHub.nameWithOwner is defined</p>
        </td>
...
<p><em>* GFM *</em> Auto-link user#issue if GitHub.nameWithOwner is defined</p>
        </td>
...
<p><em>* GFM *</em> Auto-link user/repo#issue</p>
        </td>
...
<p>Strips link definitions from text, stores the URLs and titles in
hash references.</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre></pre></div>
        </td>
...
<p>Link defs are in the form: ^[id]: url "optional title"</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre></pre></div>
        </td>
      </tr>
...
<div class="dox">
  ...
  <div class="body">
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="kd">var</span> <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/^[ ]{0,3}\[(.+)\]:[ \t]*\n?[ \t]*&lt;?(\S+?)&gt;?[ \t]*\n?[ \t]*(?:(\n*)[&quot;(](.+?)[&quot;)][ \t]*)?(?:\n+|\Z)/gm</span><span class="p">,</span>
...
<p>Oops, found blank lines, so it's not a title.
Put back the parenthetical statement we stole.</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>        <span class="k">return</span> <span class="nx">m3</span><span class="o">+</span><span class="nx">m4</span><span class="p">;</span>
...
<p>Completely remove the definition from the text</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>      <span class="k">return</span> <span class="s2">&quot;&quot;</span><span class="p">;</span>
    <span class="p">}</span>
  <span class="p">);</span>
...
<p>attacklab: Double up blank lines to reduce lookaround</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/\n/g</span><span class="p">,</span><span class="s2">&quot;\n\n&quot;</span><span class="p">);</span></pre></div>
        </td>
      </tr>
...
hard-coded:</p>
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="kd">var</span> <span class="nx">block_tags_a</span> <span class="o">=</span> <span class="s2">&quot;p|div|h[1-6]|blockquote|pre|table|dl|ol|ul|script|noscript|form|fieldset|iframe|math|ins|del&quot;</span>
...
<p>First, look for nested blocks, e.g.:
  <div>
    <div>
...
<p>attacklab: This regex can be expensive when it fails.</p>
...
<div class="dox">
  ...
  <div class="body">
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/^(&lt;(p|div|h[1-6]|blockquote|pre|table|dl|ol|ul|script|noscript|form|fieldset|iframe|math|ins|del)\b[^\r]*?\n&lt;\/\2&gt;[ \t]*(?=\n+))/gm</span><span class="p">,</span><span class="nx">hashElement</span><span class="p">);</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>Now match more liberally, simply from <code>\n&lt;tag&gt;</code> to <code>&lt;/tag&gt;\n</code></p>
        </td>
        <td class="code highlight"><div class="highlight"><pre></pre></div>
        </td>
      </tr>
...
<div class="dox">
  ...
  <div class="body">
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/^(&lt;(p|div|h[1-6]|blockquote|pre|table|dl|ol|ul|script|noscript|form|fieldset|iframe|math)\b[^\r]*?.*&lt;\/\2&gt;[ \t]*(?=\n+)\n)/gm</span><span class="p">,</span><span class="nx">hashElement</span><span class="p">);</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>Special case just for <hr />. It was easier to make a special case than
...
<p>Special case for standalone HTML comments:</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre></pre></div>
        </td>
      </tr>
...
<p>PHP and ASP-style processor instructions (<?...?> and &lt;%...%>)</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre></pre></div>
        </td>
      </tr>
...
<p>attacklab: Undo double lines (see comment at top of this function)</p>
        </td>
...
<p>Undo double lines</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">blockText</span> <span class="o">=</span> <span class="nx">blockText</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/\n\n/g</span><span class="p">,</span><span class="s2">&quot;\n&quot;</span><span class="p">);</span>
...
<p>strip trailing blank lines</p>
        </td>
...
<p>These are all the transformations that form block-level
tags like paragraphs, headers, and list items.</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">_DoHeaders</span><span class="p">(</span><span class="nx">text</span><span class="p">);</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>Do Horizontal Rules:</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="kd">var</span> <span class="nx">key</span> <span class="o">=</span> <span class="nx">hashBlock</span><span class="p">(</span><span class="s2">&quot;&lt;hr /&gt;&quot;</span><span class="p">);</span>
...
<p>We already ran _HashHTMLBlocks() before, in Markdown(), but that
was to escape raw HTML in the original Markdown source. This time,
we're escaping the markup we've just created, so that we don't wrap
<p> tags around block-level tags.</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">_HashHTMLBlocks</span><span class="p">(</span><span class="nx">text</span><span class="p">);</span>
...
<p>These are all the transformations that occur <em>within</em> block-level
tags like paragraphs, headers, and list items.</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">_DoCodeSpans</span><span class="p">(</span><span class="nx">text</span><span class="p">);</span>
...
<p>Process anchor and image tags. Images must come first,
because ![foo][f] looks like an anchor.</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">_DoImages</span><span class="p">(</span><span class="nx">text</span><span class="p">);</span>
...
<p>Make links out of things like <code>&lt;http://example.com/&gt;</code>
Must come after _DoAnchors(), because you can use &lt; and >
delimiters in inline links like <a href="url">this</a>.</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">_DoAutoLinks</span><span class="p">(</span><span class="nx">text</span><span class="p">);</span>
...
<p>Within tags -- meaning between &lt; and > -- encode [\ ` * _] so they
...
<p>Build a regex to find HTML tags and comments.  See Friedl's
"Mastering Regular Expressions", 2nd Ed., pp. 200-201.</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="kd">var</span> <span class="nx">regex</span> <span class="o">=</span> <span class="sr">/(&lt;[a-z\/!$](&quot;[^&quot;]*&quot;|&#39;[^&#39;]*&#39;|[^&#39;&quot;&gt;])*&gt;|&lt;!(--.*?--\s*)+&gt;)/gi</span><span class="p">;</span>
...
<p>Turn Markdown link shortcuts into XHTML <a> tags.</p>
...
<div class="highlight"><pre><code>        <span class="o">\</span><span class="p">[</span>
        <span class="p">(</span><span class="o">.*</span>?<span class="p">)</span>                   <span class="o">//</span> <span class="n">id</span> <span class="p">=</span> $3
        <span class="o">\</span><span class="p">]</span>
    <span class="p">)()()()()</span>                   <span class="o">//</span> <span class="n">pad</span> <span class="n">remaining</span> <span class="n">backreferences</span>
    <span class="o">/</span><span class="n">g</span><span class="p">,</span><span class="n">_DoAnchors_callback</span><span class="p">);</span>
</code></pre></div>
...
<p>Next, inline-style links: <a href="url" title="optional title">link text</a></p>
        </td>
        <td class="code highlight"><div class="highlight"><pre></pre></div>
        </td>
      </tr>
...
<div class="dox">
  ...
  <div class="body">
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/(\[((?:\[[^\]]*\]|[^\[\]])*)\]\([ \t]*()&lt;?(.*?)&gt;?[ \t]*(([&#39;&quot;])(.*?)\6[ \t]*)?\))/g</span><span class="p">,</span><span class="nx">writeAnchorTag</span><span class="p">);</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>Last, handle reference-style shortcuts: [link text]
...
<div class="dox">
  ...
  <div class="body">
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/(\[([^\[\]]+)\])()()()()()/g</span><span class="p">,</span> <span class="nx">writeAnchorTag</span><span class="p">);</span>
...
<p>lower-case and turn embedded newlines into spaces</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>      <span class="nx">link_id</span> <span class="o">=</span> <span class="nx">link_text</span><span class="p">.</span><span class="nx">toLowerCase</span><span class="p">().</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/ ?\n/g</span><span class="p">,</span><span class="s2">&quot; &quot;</span><span class="p">);</span>
    <span class="p">}</span>
...
<p>Special case for explicit empty url</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>        <span class="nx">url</span> <span class="o">=</span> <span class="s2">&quot;&quot;</span><span class="p">;</span>
...
<p>Turn Markdown image shortcuts into <img> tags.</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre></pre></div>
        </td>
      </tr>
...
<p>First, handle reference-style labeled images: ![alt text][id]</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre></pre></div>
        </td>
      </tr>
...
<div class="highlight"><pre><code>        <span class="o">\</span><span class="p">[</span>
        <span class="p">(</span><span class="o">.*</span>?<span class="p">)</span>               <span class="o">//</span> <span class="n">id</span> <span class="p">=</span> $3
        <span class="o">\</span><span class="p">]</span>
    <span class="p">)()()()()</span>               <span class="o">//</span> <span class="n">pad</span> <span class="n">rest</span> <span class="n">of</span> <span class="n">backreferences</span>
    <span class="o">/</span><span class="n">g</span><span class="p">,</span><span class="n">writeImageTag</span><span class="p">);</span>
</code></pre></div>
...
<p>Next, handle inline images:  <img src="url" alt="alt text" title="optional title" />
...
<div class="dox">
  ...
  <div class="body">
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/(!\[(.*?)\]\s?\([ \t]*()&lt;?(\S+?)&gt;?[ \t]*(([&#39;&quot;])(.*?)\6[ \t]*)?\))/g</span><span class="p">,</span><span class="nx">writeImageTag</span><span class="p">);</span>
...
<p>lower-case and turn embedded newlines into spaces</p>
        ...
        <td class="code highlight"><div class="highlight"><pre>      <span class="nx">link_id</span> <span class="o">=</span> <span class="nx">alt_text</span><span class="p">.</span><span class="nx">toLowerCase</span><span class="p">().</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/ ?\n/g</span><span class="p">,</span><span class="s2">&quot; &quot;</span><span class="p">);</span>
    <span class="p">}</span>
    <span class="nx">url</span> <span class="o">=</span> <span class="s2">&quot;#&quot;</span><span class="o">+</span><span class="nx">link_id</span><span class="p">;</span>
...
<p>attacklab: Markdown.pl adds empty title attributes to images.
...
<p>if (title != "") {</p>
        ...
        <td class="code highlight"><div class="highlight"><pre>    <span class="nx">title</span> <span class="o">=</span> <span class="nx">title</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/&quot;/g</span><span class="p">,</span><span class="s2">&quot;&amp;quot;&quot;</span><span class="p">);</span>
    <span class="nx">title</span> <span class="o">=</span> <span class="nx">escapeCharacters</span><span class="p">(</span><span class="nx">title</span><span class="p">,</span><span class="s2">&quot;*_&quot;</span><span class="p">);</span>
...
<p>}</p>
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">result</span> <span class="o">+=</span> <span class="s2">&quot; /&gt;&quot;</span><span class="p">;</span>
...
<div class="pilwrap" id="header-1">
  <h1>
    <a href="#header-1" class="pilcrow">&#182;</a>
    Header 1
  </h1>
</div>
...
<div class="pilwrap" id="header-2">
  <h2>
    <a href="#header-2" class="pilcrow">&#182;</a>
    Header 2
  </h2>
</div>
...
<div class="dox">
  ...
  <div class="body">
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/^(\#{1,6})[ \t]*(.+?)[ \t]*\#*\n+/gm</span><span class="p">,</span>
...
<p>This declaration keeps Dojo compressor from outputting garbage:</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre><span class="kd">var</span> <span class="nx">_ProcessListItems</span><span class="p">;</span>
...
<p>Form HTML ordered (numbered) and unordered (bulleted) lists.</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre></pre></div>
        </td>
      </tr>
...
<p>attacklab: add sentinel to hack around khtml/safari bug:
<a href='http://bugs.webkit.org/show_bug.cgi?id=11231'>http://bugs.webkit.org/show_bug.cgi?id=11231</a></p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">+=</span> <span class="s2">&quot;~0&quot;</span><span class="p">;</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>Re-usable pattern to match any entirel ul or ol list:</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre></pre></div>
        </td>
      </tr>
...
<div class="dox">
  <div class="summary"><p>var whole_list = /
        (                                   // $1 = whole list
            (                               // $2
                [ ]{0,3}                    // attacklab: g_tab_width - 1
  ...
  <div class="body">
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="kd">var</span> <span class="nx">whole_list</span> <span class="o">=</span> <span class="sr">/^(([ ]{0,3}([*+-]|\d+[.])[ \t]+)[^\r]+?(~0|\n{2,}(?=\S)(?![ \t]*(?:[*+-]|\d+[.])[ \t]+)))/gm</span><span class="p">;</span>
...
<p>Turn double returns into triple returns, so that we can make a
paragraph for the last item in a list, if necessary:</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>      <span class="nx">list</span> <span class="o">=</span> <span class="nx">list</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/\n{2,}/g</span><span class="p">,</span><span class="s2">&quot;\n\n\n&quot;</span><span class="p">);;</span>
...
<p>Trim any trailing whitespace, to put the closing <code>&lt;/$list_type&gt;</code>
up on the preceding line, to get it past the current stupid
HTML block parser. This is a hack to work around the terrible
hack that is the HTML block parser.</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>      <span class="nx">result</span> <span class="o">=</span> <span class="nx">result</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/\s+$/</span><span class="p">,</span><span class="s2">&quot;&quot;</span><span class="p">);</span>
...
paragraph for the last item in a list, if necessary:</p>
        ...
        <td class="code highlight"><div class="highlight"><pre>      <span class="kd">var</span> <span class="nx">list</span> <span class="o">=</span> <span class="nx">list</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/\n{2,}/g</span><span class="p">,</span><span class="s2">&quot;\n\n\n&quot;</span><span class="p">);;</span>
...
<p>attacklab: strip sentinel</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/~0/</span><span class="p">,</span><span class="s2">&quot;&quot;</span><span class="p">);</span>
...
<p>Process the contents of a single ordered or unordered list, splitting it
 into individual list items.</p>

<p>The $g_list_level global keeps track of when we're inside a list.
...
starting cardinal number; e.g. "1." or "a.".</p>
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">g_list_level</span><span class="o">++</span><span class="p">;</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>trim trailing blank lines:</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">list_str</span> <span class="o">=</span> <span class="nx">list_str</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/\n{2,}$/</span><span class="p">,</span><span class="s2">&quot;\n&quot;</span><span class="p">);</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>attacklab: add sentinel to emulate \z</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">list_str</span> <span class="o">+=</span> <span class="s2">&quot;~0&quot;</span><span class="p">;</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<div class="dox">
  <div class="summary"><p>list_str = list_str.replace(/
            (\n)?                           // leading line = $1
...
<p>Recursion for sub-lists:</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>        <span class="nx">item</span> <span class="o">=</span> <span class="nx">_DoLists</span><span class="p">(</span><span class="nx">_Outdent</span><span class="p">(</span><span class="nx">item</span><span class="p">));</span>
...
<p>attacklab: strip sentinel</p>
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">list_str</span> <span class="o">=</span> <span class="nx">list_str</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/~0/g</span><span class="p">,</span><span class="s2">&quot;&quot;</span><span class="p">);</span>
...
<p>Process Markdown <code>&lt;pre&gt;&lt;code&gt;</code> blocks.</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre></pre></div>
        </td>
      </tr>
...
<p>attacklab: sentinel workarounds for lack of \A and \Z, safari\khtml bug</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">+=</span> <span class="s2">&quot;~0&quot;</span><span class="p">;</span>
...
<p>Code Fencing is a GitHub flavored MD concept. Basically you can wrap
...
and {code} is your code</p>
        ...
        <td class="code highlight"><div class="highlight"><pre><span class="kd">var</span> <span class="nx">_DoCodeFencing</span> <span class="o">=</span> <span class="kd">function</span><span class="p">(</span><span class="nx">text</span><span class="p">)</span> <span class="p">{</span>
...
<p>HTML for this is copied from GitHub directly for compatibility, except the lang="" attribute</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>      <span class="kd">var</span> <span class="nx">codeblock</span> <span class="o">=</span> <span class="s1">&#39;&lt;div class=&quot;highlight&quot;&gt;&lt;pre lang=&quot;&#39;</span><span class="o">+</span><span class="nx">m1</span><span class="o">+</span><span class="s1">&#39;&quot;&gt;&#39;</span><span class="o">+</span><span class="nx">m2</span><span class="o">+</span><span class="s1">&#39;&lt;/pre&gt;&lt;/div&gt;&#39;</span><span class="p">;</span>
...
<div class="highlight"><pre><code> <span class="n">Just</span> <span class="n">type</span> ``<span class="n">foo</span> `<span class="n">bar</span>` <span class="n">baz</span>`` <span class="n">at</span> <span class="n">the</span> <span class="n">prompt</span><span class="p">.</span>
</code></pre></div>
...
<div class="highlight"><pre><code> <span class="nt">&lt;p&gt;</span>Just type <span class="nt">&lt;code&gt;</span>foo `bar` baz<span class="nt">&lt;/code&gt;</span> at the prompt.<span class="nt">&lt;/p&gt;</span>
</code></pre></div>
...
<div class="highlight"><pre><code> <span class="p">...</span> <span class="n">type</span> `` `<span class="n">bar</span>` `` <span class="p">...</span>
</code></pre></div>
...
<div class="highlight"><pre><code> ... type <span class="nt">&lt;code&gt;</span>`bar`<span class="nt">&lt;/code&gt;</span> ...
</code></pre></div>
...
<div class="dox">
  ...
  <div class="body">
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/(^|[^\\])(`+)([^\r]*?[^`])\2(?!`)/gm</span><span class="p">,</span>
    <span class="kd">function</span><span class="p">(</span><span class="nx">wholeMatch</span><span class="p">,</span><span class="nx">m1</span><span class="p">,</span><span class="nx">m2</span><span class="p">,</span><span class="nx">m3</span><span class="p">,</span><span class="nx">m4</span><span class="p">)</span> <span class="p">{</span>
...
<p>Encode/escape certain characters inside Markdown code runs.
...
entities within a Markdown code span.</p>
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/&amp;/g</span><span class="p">,</span><span class="s2">&quot;&amp;amp;&quot;</span><span class="p">);</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>Do the angle bracket song and dance:</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/&lt;/g</span><span class="p">,</span><span class="s2">&quot;&amp;lt;&quot;</span><span class="p">);</span>
...
<p>Now, escape characters that are magic in Markdown:</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">escapeCharacters</span><span class="p">(</span><span class="nx">text</span><span class="p">,</span><span class="s2">&quot;\*_{}[]\\&quot;</span><span class="p">,</span><span class="kc">false</span><span class="p">);</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
<div class="pilwrap" id="jj-the-line-above-breaks-this-">
  <h2>
    <a href="#jj-the-line-above-breaks-this-" class="pilcrow">&#182;</a>
...
<div class="dox">
  <div class="summary"><p>Item</p>
  </div>
  <div class="body"><p>//   1. Subitem</p>

<p>//            special char: *
//---</p>


<div class="highlight"><pre><code><span class="k">return</span> <span class="n">text</span><span class="p">;</span>
</code></pre></div>
...
<div class="highlight"><pre><code><span class="c1">// &lt;strong&gt; must go first:</span>
<span class="n">text</span> <span class="o">=</span> <span class="n">text</span><span class="p">.</span><span class="n">replace</span><span class="p">(</span><span class="o">/</span><span class="p">(</span><span class="err">\</span><span class="o">*</span><span class="err">\</span><span class="o">*|</span><span class="n">__</span><span class="p">)(</span><span class="o">?=</span><span class="err">\</span><span class="no">S</span><span class="p">)([</span><span class="o">^</span><span class="err">\</span><span class="n">r</span><span class="p">]</span><span class="o">*?</span><span class="err">\</span><span class="no">S</span><span class="p">[</span><span class="o">*</span><span class="n">_</span><span class="p">]</span><span class="o">*</span><span class="p">)</span><span class="err">\</span><span class="mh">1</span><span class="o">/</span><span class="n">g</span><span class="p">,</span>
    <span class="s">&quot;&lt;strong&gt;$2&lt;/strong&gt;&quot;</span><span class="p">);</span>

<span class="n">text</span> <span class="o">=</span> <span class="n">text</span><span class="p">.</span><span class="n">replace</span><span class="p">(</span><span class="o">/</span><span class="p">(</span><span class="err">\</span><span class="n">w</span><span class="p">)</span><span class="n">_</span><span class="p">(</span><span class="err">\</span><span class="n">w</span><span class="p">)</span><span class="o">/</span><span class="n">g</span><span class="p">,</span> <span class="s">&quot;$1~E95E$2&quot;</span><span class="p">)</span> <span class="c1">// ** GFM **  &quot;~E95E&quot; == escaped &quot;_&quot;</span>
<span class="n">text</span> <span class="o">=</span> <span class="n">text</span><span class="p">.</span><span class="n">replace</span><span class="p">(</span><span class="o">/</span><span class="p">(</span><span class="err">\</span><span class="o">*|</span><span class="n">_</span><span class="p">)(</span><span class="o">?=</span><span class="err">\</span><span class="no">S</span><span class="p">)([</span><span class="o">^</span><span class="err">\</span><span class="n">r</span><span class="p">]</span><span class="o">*?</span><span class="err">\</span><span class="no">S</span><span class="p">)</span><span class="err">\</span><span class="mh">1</span><span class="o">/</span><span class="n">g</span><span class="p">,</span>
    <span class="s">&quot;&lt;em&gt;$2&lt;/em&gt;&quot;</span><span class="p">);</span>
...
<div class="highlight"><pre><code><span class="o">/*</span>
    <span class="n">text</span> <span class="o">=</span> <span class="n">text</span><span class="p">.</span><span class="n">replace</span><span class="p">(</span><span class="o">/</span>
    <span class="p">(</span>                               <span class="c1">// Wrap whole match in $1</span>
        <span class="p">(</span>
            <span class="o">^</span><span class="p">[</span> <span class="err">\</span><span class="n">t</span><span class="p">]</span><span class="o">*&gt;</span><span class="p">[</span> <span class="err">\</span><span class="n">t</span><span class="p">]</span><span class="o">?</span>          <span class="c1">// &#39;&gt;&#39; at the start of a line</span>
            <span class="p">.</span><span class="o">+</span><span class="err">\</span><span class="n">n</span>                    <span class="c1">// rest of the first line</span>
            <span class="p">(.</span><span class="o">+</span><span class="err">\</span><span class="n">n</span><span class="p">)</span><span class="o">*</span>                 <span class="c1">// subsequent consecutive lines</span>
            <span class="err">\</span><span class="n">n</span><span class="o">*</span>                     <span class="c1">// blanks</span>
        <span class="p">)</span><span class="o">+</span>
    <span class="p">)</span>
    <span class="o">/</span><span class="n">gm</span><span class="p">,</span> <span class="k">function</span><span class="p">(){...});</span>
</code></pre></div>
...
<p>attacklab: hack around Konqueror 3.5.4 bug:
"----------bug".replace(/^-/g,"") == "bug"</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>      <span class="nx">bq</span> <span class="o">=</span> <span class="nx">bq</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/^[ \t]*&gt;[ \t]?/gm</span><span class="p">,</span><span class="s2">&quot;~0&quot;</span><span class="p">);</span> <span class="c1">// trim one level of quoting</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>attacklab: clean up hack</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>      <span class="nx">bq</span> <span class="o">=</span> <span class="nx">bq</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/~0/g</span><span class="p">,</span><span class="s2">&quot;&quot;</span><span class="p">);</span>
...
<p>These leading spaces screw with <pre> content, so we need to fix that:</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>      <span class="nx">bq</span> <span class="o">=</span> <span class="nx">bq</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span>
...
<p>attacklab: hack around Konqueror 3.5.4 bug:</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>          <span class="nx">pre</span> <span class="o">=</span> <span class="nx">pre</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/^  /mg</span><span class="p">,</span><span class="s2">&quot;~0&quot;</span><span class="p">);</span>
...
<p>Strip leading and trailing lines:</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/^\n+/g</span><span class="p">,</span><span class="s2">&quot;&quot;</span><span class="p">);</span>
  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/\n+$/g</span><span class="p">,</span><span class="s2">&quot;&quot;</span><span class="p">);</span>
...
<p>Wrap <p> tags.</p>
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="kd">var</span> <span class="nx">end</span> <span class="o">=</span> <span class="nx">grafs</span><span class="p">.</span><span class="nx">length</span><span class="p">;</span>
...
<p>if this is an HTML marker, copy it</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>    <span class="k">if</span> <span class="p">(</span><span class="nx">str</span><span class="p">.</span><span class="nx">search</span><span class="p">(</span><span class="sr">/~K(\d+)K/g</span><span class="p">)</span> <span class="o">&gt;=</span> <span class="mi">0</span><span class="p">)</span> <span class="p">{</span>
...
<p>Unhashify HTML blocks</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">end</span> <span class="o">=</span> <span class="nx">grafsOut</span><span class="p">.</span><span class="nx">length</span><span class="p">;</span>
...
<p>if this is a marker for an html block...</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>    <span class="k">while</span> <span class="p">(</span><span class="nx">grafsOut</span><span class="p">[</span><span class="nx">i</span><span class="p">].</span><span class="nx">search</span><span class="p">(</span><span class="sr">/~K(\d+)K/</span><span class="p">)</span> <span class="o">&gt;=</span> <span class="mi">0</span><span class="p">)</span> <span class="p">{</span>
...
<p>Smart processing for ampersands and angle brackets that need to be encoded.</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre></pre></div>
        </td>
      </tr>
...
<p>Ampersand-encoding based entirely on Nat Irons's Amputator MT plugin:
  <a href='http://bumppo.net/projects/amputator/'>http://bumppo.net/projects/amputator/</a></p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/&amp;(?!#?[xX]?(?:[0-9a-fA-F]+|\w+);)/g</span><span class="p">,</span><span class="s2">&quot;&amp;amp;&quot;</span><span class="p">);</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>Encode naked &lt;'s</p>
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/&lt;(?![a-z\/?\$!])/gi</span><span class="p">,</span><span class="s2">&quot;&amp;lt;&quot;</span><span class="p">);</span>
...
<p>attacklab: The polite way to do this is with the new
escapeCharacters() function:</p>


<div class="highlight"><pre><code><span class="n">text</span> <span class="p">=</span> <span class="n">escapeCharacters</span><span class="p">(</span><span class="n">text</span><span class="p">,</span>&quot;<span class="o">\\</span>&quot;<span class="p">,</span><span class="n">true</span><span class="p">);</span>
<span class="n">text</span> <span class="p">=</span> <span class="n">escapeCharacters</span><span class="p">(</span><span class="n">text</span><span class="p">,</span>&quot;`<span class="o">*</span><span class="n">_</span><span class="p">{}[]()</span><span class="o">&gt;</span>#<span class="o">+-</span><span class="p">.</span>!&quot;<span class="p">,</span><span class="n">true</span><span class="p">);</span>
</code></pre></div>
...
as an optimization for Firefox.  This function gets called a LOT.</p>
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/\\(\\)/g</span><span class="p">,</span><span class="nx">escapeCharacters_callback</span><span class="p">);</span>
...
<p>Email addresses: <a href="&#x6D;ai&#108;t&#111;:a&#x64;&#100;&#114;&#x65;s&#115;&#64;&#100;&#x6F;&#109;a&#x69;&#x6E;.&#102;&#111;&#111;">a&#x64;&#100;&#114;&#x65;s&#115;&#64;&#100;&#x6F;&#109;a&#x69;&#x6E;.&#102;&#111;&#111;</a></p>
        </td>
        <td class="code highlight"><div class="highlight"><pre></pre></div>
        </td>
      </tr>
...
<div class="dox">
  <div class="summary"><p>text = text.replace(/
            ...
            >
        /gi, _DoAutoLinks_callback());</p>
  </div>
  <div class="body">
  </div>
</div>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/&lt;(?:mailto:)?([-.\w]+\@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)&gt;/gi</span><span class="p">,</span>
    <span class="kd">function</span><span class="p">(</span><span class="nx">wholeMatch</span><span class="p">,</span><span class="nx">m1</span><span class="p">)</span> <span class="p">{</span>
...
<p>Input: an email address, e.g. "<a href='mailto:foo@example.com'>foo@example.com</a>"</p>
...
<p>attacklab: why can't javascript speak hex?</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="kd">function</span> <span class="nx">char2hex</span><span class="p">(</span><span class="nx">ch</span><span class="p">)</span> <span class="p">{</span>
...
<p>this <em>must</em> be encoded. I insist.</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>      <span class="nx">ch</span> <span class="o">=</span> <span class="nx">encode</span><span class="p">[</span><span class="nb">Math</span><span class="p">.</span><span class="nx">floor</span><span class="p">(</span><span class="nb">Math</span><span class="p">.</span><span class="nx">random</span><span class="p">()</span><span class="o">*</span><span class="mi">2</span><span class="p">)](</span><span class="nx">ch</span><span class="p">);</span>
...
<p>leave ':' alone (to spot mailto: later)</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>      <span class="kd">var</span> <span class="nx">r</span> <span class="o">=</span> <span class="nb">Math</span><span class="p">.</span><span class="nx">random</span><span class="p">();</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>roughly 10% raw, 45% hex, 45% dec</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>      <span class="nx">ch</span> <span class="o">=</span>  <span class="p">(</span>
...
<p>Swap back in all the special characters we've hidden.</p>
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/~E(\d+)E/g</span><span class="p">,</span>
    <span class="kd">function</span><span class="p">(</span><span class="nx">wholeMatch</span><span class="p">,</span><span class="nx">m1</span><span class="p">)</span> <span class="p">{</span>
...
<p>Remove one level of line-leading tabs or spaces</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre></pre></div>
        </td>
      </tr>
...
"----------bug".replace(/^-/g,"") == "bug"</p>
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/^(\t|[ ]{1,4})/gm</span><span class="p">,</span><span class="s2">&quot;~0&quot;</span><span class="p">);</span> <span class="c1">// attacklab: g_tab_width</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>attacklab: clean up hack</p>
        ...
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/~0/g</span><span class="p">,</span><span class="s2">&quot;&quot;</span><span class="p">)</span>
...
<p>attacklab: Detab's completely rewritten for speed.
...
<p>expand first n-1 tabs</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/\t(?=\t)/g</span><span class="p">,</span><span class="s2">&quot;    &quot;</span><span class="p">);</span> <span class="c1">// attacklab: g_tab_width</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>replace the nth with two sentinels</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/\t/g</span><span class="p">,</span><span class="s2">&quot;~A~B&quot;</span><span class="p">);</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>use the sentinel to anchor our regex so it doesn't explode</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/~B(.+?)~A/g</span><span class="p">,</span>
    <span class="kd">function</span><span class="p">(</span><span class="nx">wholeMatch</span><span class="p">,</span><span class="nx">m1</span><span class="p">,</span><span class="nx">m2</span><span class="p">)</span> <span class="p">{</span>
...
<p>there <em>must</em> be a better way to do this:</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>      <span class="k">for</span> <span class="p">(</span><span class="kd">var</span> <span class="nx">i</span><span class="o">=</span><span class="mi">0</span><span class="p">;</span> <span class="nx">i</span><span class="o">&lt;</span><span class="nx">numSpaces</span><span class="p">;</span> <span class="nx">i</span><span class="o">++</span><span class="p">)</span> <span class="nx">leadingText</span><span class="o">+=</span><span class="s2">&quot; &quot;</span><span class="p">;</span>
...
<p>clean up sentinels</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="nx">text</span> <span class="o">=</span> <span class="nx">text</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/~A/g</span><span class="p">,</span><span class="s2">&quot;    &quot;</span><span class="p">);</span>  <span class="c1">// attacklab: g_tab_width</span>
...
<p>attacklab: Utility functions</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre><span class="kd">var</span> <span class="nx">escapeCharacters</span> <span class="o">=</span> <span class="kd">function</span><span class="p">(</span><span class="nx">text</span><span class="p">,</span> <span class="nx">charsToEscape</span><span class="p">,</span> <span class="nx">afterBackslash</span><span class="p">)</span> <span class="p">{</span></pre></div>
        </td>
      </tr>
      <tr>
        <td class="docs">
...
<p>First we have to escape the escape characters so that
we can build a character class out of them</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>  <span class="kd">var</span> <span class="nx">regexString</span> <span class="o">=</span> <span class="s2">&quot;([&quot;</span> <span class="o">+</span> <span class="nx">charsToEscape</span><span class="p">.</span><span class="nx">replace</span><span class="p">(</span><span class="sr">/([\[\]\\])/g</span><span class="p">,</span><span class="s2">&quot;\\$1&quot;</span><span class="p">)</span> <span class="o">+</span> <span class="s2">&quot;])&quot;</span><span class="p">;</span>
