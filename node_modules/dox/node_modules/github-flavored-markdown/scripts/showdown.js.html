...
<div class="dox">
  <div class="summary"><p>var text = text.replace(/<br />        (                       // save in $1<br />            ^                   // start of line  (with /m)<br />            &lt;($block_tags_a)   // start tag = $2<br />            \b                  // word break<br />                                // attacklab: hack around khtml/pcre bug...<br />            [^\r]<em>?\n           // any number of lines, minimally matching<br />            </\2>               // the matching end tag<br />            [ \t]</em>              // trailing spaces/tabs<br />            (?=\n+)             // followed by a newline<br />        )                       // attacklab: there are sentinel newlines at end of document<br />        /gm,function(){...}};</p>
  </div>
  <div class="body">
  </div>
</div>
...
<div class="dox">
  <div class="summary"><p>var text = text.replace(/<br />        (                       // save in $1<br />            ^                   // start of line  (with /m)<br />            &lt;($block_tags_b)   // start tag = $2<br />            \b                  // word break<br />                                // attacklab: hack around khtml/pcre bug...<br />            [^\r]<em>?             // any number of lines, minimally matching<br />            .</em></\2>             // the matching end tag<br />            [ \t]*              // trailing spaces/tabs<br />            (?=\n+)             // followed by a newline<br />        )                       // attacklab: there are sentinel newlines at end of document<br />        /gm,function(){...}};</p>
  </div>
  <div class="body">
  </div>
</div>
...
<div class="dox">
  <div class="summary"><p>text = text.replace(/<br />        (                           // wrap whole match in $1<br />            [<br />            (<br />                (?:<br />                    [[^]]<em>]      // allow brackets nested one level<br />                    |<br />                    [^[]           // or anything else<br />                )</em><br />            )<br />            ]</p>
  </div>
  <div class="body"><pre><code>        [ ]?                    // one optional space
...
<div class="dox">
  <div class="summary"><p>text = text.replace(/<br />            (                       // wrap whole match in $1<br />                [<br />                (<br />                    (?:<br />                        [[^]]<em>]  // allow brackets nested one level<br />                    |<br />                    [^[]]         // or anything else<br />                )<br />            )<br />            ]<br />            (                      // literal paren<br />            [ \t]</em><br />            ()                      // no id, so leave $3 empty<br />            <?(.<em>?)>?               // href = $4<br />            [ \t]</em><br />            (                       // $5<br />                (['"])              // quote char = $6<br />                (.<em>?)               // Title = $7<br />                \6                  // matching quote<br />                [ \t]</em>              // ignore any spaces/tabs between closing quote and )<br />            )?                      // title is optional<br />            )<br />        )<br />        /g,writeAnchorTag);</p>
  </div>
  <div class="body">
  </div>
</div>
...
<div class="dox">
  <div class="summary"><p>text = text.replace(/<br />        (                           // wrap whole match in $1<br />            [<br />            ([^[]]+)              // link text = $2; can't contain '[' or ']'<br />            ]<br />        )()()()()()                 // pad rest of backreferences<br />        /g, writeAnchorTag);</p>
  </div>
  <div class="body">
  </div>
</div>
...
<div class="dox">
  <div class="summary"><p>text = text.replace(/<br />        (                       // wrap whole match in $1<br />            ![<br />            (.*?)               // alt text = $2<br />            ]</p>
  </div>
  <div class="body"><pre><code>        [ ]?                // one optional space
        (?:\n[ ]*)?         // one optional newline followed by spaces
...
<div class="dox">
  <div class="summary"><p>text = text.replace(/<br />        (                       // wrap whole match in $1<br />            ![<br />            (.<em>?)               // alt text = $2<br />            ]<br />            \s?                 // One optional whitespace character<br />            (                  // literal paren<br />            [ \t]</em><br />            ()                  // no id, so leave $3 empty<br />            <?(\S+?)>?          // src url = $4<br />            [ \t]*<br />            (                   // $5<br />                (['"])          // quote char = $6<br />                (.<em>?)           // title = $7<br />                \6              // matching quote<br />                [ \t]</em><br />            )?                  // title is optional<br />        )<br />        )<br />        /g,writeImageTag);</p>
  </div>
  <div class="body">
  </div>
</div>
...
<div class="dox">
  <div class="summary"><p>text = text.replace(/<br />            ^(#{1,6})              // $1 = string of #'s<br />            [ \t]*<br />            (.+?)                   // $2 = Header text<br />            [ \t]*<br />            #*                     // optional closing #'s (not counted)<br />            \n+<br />        /gm, function() {...});</p>
  </div>
  <div class="body">
  </div>
</div>
...
<div class="dox">
  <div class="summary"><p>var whole_list = /<br />        (                                   // $1 = whole list<br />            (                               // $2<br />                [ ]{0,3}                    // attacklab: g_tab_width - 1<br />                ([<em>+-]|\d+[.])              // $3 = first list item marker<br />                [ \t]+<br />            )<br />            [^\r]+?<br />            (                               // $4<br />                ~0                         // sentinel for workaround; should be $<br />            |<br />                \n{2,}<br />                (?=\S)<br />                (?!                         // Negative lookahead for another list item marker<br />                    [ \t]</em><br />                    (?:[*+-]|\d+[.])[ \t]+<br />                )<br />            )<br />        )/g</p>
  </div>
  <div class="body">
  </div>
</div>
...
<div class="dox">
  <div class="summary"><p>text = text.replace(/<br />            (^|[^\])                   // Character before opening <code>can't be a backslash<br />            (</code>+)                        // $2 = Opening run of <code><br />            (                           // $3 = The code block<br />                [^\r]*?<br />                [^</code>]                    // attacklab: work around lack of lookbehind<br />            )<br />            \2                          // Matching closer<br />            (?!`)<br />        /gm, function(){...});</p>
  </div>
  <div class="body">
  </div>
</div>
...
<div class="dox">
  <div class="summary"><p>text = text.replace(/<br />            &lt;<br />            (?:mailto:)?<br />            (<br />                [-.\w]+<br />                \@<br />                [-a-z0-9]+(.[-a-z0-9]+)*.[a-z]+<br />            )<br />            ><br />        /gi, _DoAutoLinks_callback());</p>
  </div>
  <div class="body">
  </div>
</div>
...
<p>Input: an email address, e.g. "foo@example.com"</p>
...
<span class="p">}</span> <span class="c1">// end of Showdown.converter</span>
  ...
  <script>
    makeTree({"files":["README.md"],"dirs":{"src":{"files":["docker.js"]},"res":{"files":["script.js"]},"lib":{"files":["showdown.js"]},"node_modules":{"dirs":{"mkdirp":{"files":["README.markdown","index.js"],"dirs":{"test":{"files":["perm.js","perm_sync.js","umask_sync.js","umask.js","clobber.js","rel.js","mkdirp.js","return_sync.js","sync.js","race.js","chmod.js","return.js"]},"examples":{"files":["pow.js"]}}},"commander":{"files":["index.js","Readme.md","History.md"],"dirs":{"test":{"files":["test.options.defaults.given.js","test.options.args.optional.given.js","test.options.bool.no.js","test.options.coercion.js","test.options.bool.small.combined.js","test.options.bool.small.js","test.options.defaults.js","test.options.camelcase.js","test.options.args.optional.js","test.options.bool.js"]},"lib":{"files":["commander.js"]}}},"dox":{"files":["index.js","Readme.md","History.md"],"dirs":{"test":{"files":["dox.test.js"],"dirs":{"fixtures":{"files":["a.js","c.js","d.js","b.js"]}}},"lib":{"files":["dox.js","utils.js"]},"node_modules":{"dirs":{"github-flavored-markdown":{"files":["preview.md","index.md","README.md"],"dirs":{"scripts":{"files":["preview.js","showdown.js"]}}},"commander":{"files":["index.js","Readme.md","History.md"],"dirs":{"test":{"files":["test.options.defaults.given.js","test.options.args.optional.given.js","test.options.bool.no.js","test.options.coercion.js","test.options.bool.small.combined.js","test.options.bool.small.js","test.options.defaults.js","test.options.camelcase.js","test.options.args.optional.js","test.options.bool.js"]},"lib":{"files":["commander.js"]}}}}}}}}}}}, '../../../../../', 'node_modules/dox/node_modules/github-flavored-markdown/scripts/showdown.js');
  </script>
</body>
</html>
